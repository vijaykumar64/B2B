import { Opportunity, ConsultingService } from './types';

export const MOCK_OPPORTUNITIES: Opportunity[] = [
  {
    id: '1',
    type: 'brand',
    brand_name: 'Tea Point Express',
    category: 'Food & Beverage',
    minInvestment: 500000,
    maxInvestment: 1000000,
    investment_range: '₹5L - ₹10L',
    description: 'India\'s largest organized tea brand. Perfect for Tier 2 city transit hubs.',
    is_verified: true,
    image: 'https://images.unsplash.com/photo-1544787210-282aa7ad2021?auto=format&fit=crop&q=80',
    location: 'Pan India',
    owner_uid: 'brand-1'
  },
  {
    ...
    investment_range: '₹10L - ₹15L',
    description: 'Trusted healthcare brand. High demand in Tier 3 cities with growing medical needs.',
    is_verified: true,
  ...
  },
  {
    id: 'd1',
    type: 'brand',
    brand_name: 'Noble Seeds & Agri',
    category: 'Agriculture',
    minInvestment: 25000,
    maxInvestment: 50000,
    investment_range: '₹25K - ₹50K',
    description: 'High-yield organic seeds for local agricultural practitioners. Direct supply chain with branding support.',
    is_verified: true,
  ...
  },
  {
    id: 'd2',
    type: 'brand',
    brand_name: 'BrightLite Solar Systems',
    category: 'Energy',
    minInvestment: 15000,
    maxInvestment: 30000,
    investment_range: '₹15K - ₹30K',
    description: 'Sustainable solar lighting solutions for developing regions. Asset-light model for entry-level entrepreneurs.',
    is_verified: true,
    image: 'https://images.unsplash.com/photo-1542332213-9b5a5a3fab35?auto=format&fit=crop&q=80',
    location: 'Pan India',
    owner_uid: 'brand-3'
  },
  {
    id: 'd3',
    type: 'brand',
    brand_name: 'Artisan Textile Network',
    category: 'Textiles',
    minInvestment: 10000,
    maxInvestment: 25000,
    investment_range: '₹10K - ₹25K',
    description: 'Premium hand-woven textiles connecting heritage artisans with modern retail markets.',
    is_verified: true,
...
export const CONSULTING_SERVICES: ConsultingService[] = [
  {
    ...
    description: 'Get detailed ROI projections and break-even analysis for your chosen brand partnership.',
    icon: 'TrendingUp'
  },
  {
    id: 'c2',
    title: 'Legal & Compliance',
    description: 'Expert guidance on brand agreements, local permits, and registration.',
    icon: 'ShieldCheck'
  },
  {
    id: 'c3',
    title: 'Location Analysis',
    description: 'AI-driven footfall prediction and demographic analysis for your site.',
    icon: 'MapPin'
  }
];
